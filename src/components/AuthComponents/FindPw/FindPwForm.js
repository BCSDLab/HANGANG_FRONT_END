...
import { Input as LoginInput } from "../Login/LoginForm";
import { AlertImg, Button, CheckImg, ImageWrapper } from "../SignUp/SignUpForm";
...
const FindPwForm = ({ infos, error, onChange, onSubmit }) => {
